...
"use strict";
/*!**********************************************!*\
  !*** ./src/blocks/testimonial-stats/view.js ***!
  \**********************************************/
__webpack_require__.r(__webpack_exports__);
...
/* harmony import */ var _shared_styles_stats_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../shared/styles/stats.scss */ "./src/shared/styles/stats.scss");



const format = (num, decimals) => decimals > 0 ? num.toFixed(decimals) : Math.round(num).toLocaleString();
const animateEl = el => {
...
const initStats = () => {
  const numbers = [...document.querySelectorAll('.bTestimonialStats[data-animate="1"] .btb-ts-number')].filter(el => !el.dataset.bound);
  if (!numbers.length) {
    return;
  }
  numbers.forEach(el => {
