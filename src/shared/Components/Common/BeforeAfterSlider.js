		...
		<div className="bBeforeAfter">
			...
			>
				<div className="ba-before">
					...
					{ showLabels && beforeLabel && <span className="ba-label ba-label-before">{ beforeLabel }</span> }
				</div>
				<div className="ba-after">
					<img src={ afterUrl } alt={ afterImg?.alt || afterLabel || 'After' } />
					{ showLabels && afterLabel && <span className="ba-label ba-label-after">{ afterLabel }</span> }
				</div>
				<div
					className="ba-handle"
