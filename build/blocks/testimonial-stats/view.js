...
const BlockIcon = ({
  ...
  if (!svg) {
    const fallback = renderFallback ? renderFallback(resolveIconColor(icon, defaultColor)) : null;
...
/* harmony import */ var _utils_icons__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ../../../utils/icons */ "./src/shared/utils/icons.js");
...
const Layout = ({
  ...
  if (layout === "trust-badges") {
    ...
    const trustItems = [{
      ...
      color: _utils_icons__WEBPACK_IMPORTED_MODULE_14__.BRAND_COLOR,
    ...
    if (hasRepeater) {
      return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        ...
        return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
          ...
          icon: (0,_utils_blockIcons__WEBPACK_IMPORTED_MODULE_18__.getIcon)(attributes, slot?.slot || `trust${index}`),
          size: 32,
          defaultColor: slot?.color || _utils_icons__WEBPACK_IMPORTED_MODULE_14__.BRAND_COLOR,
          renderFallback: color => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("svg", {
            viewBox: "0 0 24 24",
            width: "32",
            height: "32"
  ...
  if (layout === "testimonial-stats") {
    ...
    if (hasRepeater) {
      return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
        ...
        className: `stats-grid ${attributes.surfaceColor || attributes.borderColor ? "has-surface" : ""}`,
        style: gridVars
  ...
  if (layout === "testimonials-popup-modal") {
    return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      ...
      className: `layoutSection btb-popup-modal-grid ${theme} columns-${previewCols} columns-tablet-${tablet} columns-mobile-${mobile} ${isBackend ? "is-editing" : ""}`
    }, items.map((item, index) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
      key: index,
  ...
  ...(identityClasses.includes(`${arrangement}-layout`) ? [] : [`${arrangement}-layout`]), theme, `columns-${previewCols}`, `columns-tablet-${tablet}`, `columns-mobile-${mobile}`, isBackend ? "is-editing" : ""].filter(Boolean).join(" ");
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
...
const Marquee = ({
  ...
  const trackClasses = ["marquee-track", pauseOnHover ? "pause-on-hover" : "", isBackend && pauseInEditor ? "is-paused" : ""].filter(Boolean).join(" ");
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
...
const Style = ({
  ...
  "display: flex;", "align-items: center;", "justify-content: center;", "box-sizing: border-box;", navBg ? `background: ${navBg};` : "", navBorder ? (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getBorderCSS)(navBorder) : ""].filter(Boolean).join("\n\t\t\t") : "";
  ...
  const arrowHover = [navHoverColor ? `color: ${navHoverColor};` : "", navHoverBg ? `background: ${navHoverBg};` : ""].filter(Boolean).join("\n\t\t\t");
  ...
  const degDividerCSS = [isSet(degDivider?.width) ? `border-width: ${degDivider.width}px;` : "", degDivider?.color ? `border-color: ${degDivider.color};` : "", isSet(degDivider?.length) ? `width: ${degDivider.length}px;` : ""].filter(Boolean).join("\n\t\t\t");
  ...
  const fontImports = [nameTypo, degTypo, textTypo, expandedTypo].map(typo => (0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)("", typo)?.googleFontLink || "").filter(Boolean).join("\n");
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("style", {
    dangerouslySetInnerHTML: {
      __html: `
		...
		${(0,_bpl_tools_utils_getCSS__WEBPACK_IMPORTED_MODULE_2__.getTypoCSS)(`${mainEl} .expandBtn`, expandedTypo)?.styles || ""}
      ...
      ""}
		...
		${expandHoverColor ? `${mainEl} .expandBtn:hover, ${mainEl} .expandBtn:focus-visible { color: ${expandHoverColor}; }` : ""}
...
const TestimonialForm = ({
  ...
  return (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
  ...
  }, title), field(`${(0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Name', 'b-testimonials-block')} *`, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
    type: "text",
    name: "name",
    required: true,
    disabled: isBackend
  })), fields?.email && field((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Email', 'b-testimonials-block'), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
    type: "email",
    name: "email",
    disabled: isBackend
  })), fields?.designation && field((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Designation', 'b-testimonials-block'), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
    type: "text",
    name: "designation",
    disabled: isBackend
  })), fields?.company && field((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Company', 'b-testimonials-block'), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
    type: "text",
    name: "company",
    disabled: isBackend
  })), fields?.rating && field((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Rating', 'b-testimonials-block'), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("select", {
    name: "rating",
    defaultValue: "5",
    disabled: isBackend
    ...
    key: n,
    value: n
  }, n)))), fields?.image && field((0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Photo', 'b-testimonials-block'), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("input", {
    type: "file",
    name: "image",
    accept: "image/*",
    disabled: isBackend
  })), field(`${(0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_1__.__)('Review', 'b-testimonials-block')} *`, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("textarea", {
    name: "review",
    required: true,
    disabled: isBackend
  })), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("button", {
...
const VideoCard = ({
  ...
  }, SandBox && (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)(SandBox, {
    html: embedHtml,
...
const ICON_LAYOUTS = {
  ...
  "trust-badges": {
    ...
    slots: [{
      key: "trust0",
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)("Badge 1 Icon", "b-testimonials-block")
    }, {
      key: "trust1",
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)("Badge 2 Icon", "b-testimonials-block")
    }, {
      key: "trust2",
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)("Badge 3 Icon", "b-testimonials-block")
    }, {
      key: "trust3",
      label: (0,_wordpress_i18n__WEBPACK_IMPORTED_MODULE_0__.__)("Badge 4 Icon", "b-testimonials-block")
    }]
  },
  "audio-testimonials": {
    size: 40,
...
const initStats = () => {
  const numbers = [...document.querySelectorAll('.bTestimonialStats[data-animate="1"] .stat-number')].filter(el => !el.dataset.bound);
  if (!numbers.length) {
    return;
  }
  numbers.forEach(el => {
